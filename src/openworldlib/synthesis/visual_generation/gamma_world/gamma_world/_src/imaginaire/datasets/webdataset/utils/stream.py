...
#   import gamma_world._src.imaginaire.datasets.webdataset.utils.stream as stream_module
...
# Python:  import gamma_world._src.imaginaire.datasets.webdataset.utils.stream as stream_module
...
def _write_throughput_ipc() -> None:
    ...
    try:
        s = _global_throughput_stats
        rank = s.get_rank()
        ipc_root = Path(os.environ.get("THROUGHPUT_STATS_DIR", tempfile.gettempdir())) / "throughput_stats"
        ipc_dir = ipc_root / f"rank_{rank}"
