...
from gamma_world._src.imaginaire.utils.easy_io.backends import backends, prefix_to_backends
from gamma_world._src.imaginaire.utils.easy_io.file_client import FileClient
from gamma_world._src.imaginaire.utils.easy_io.handlers import file_handlers
...
def _parse_uri_prefix(uri: Union[str, Path]) -> str:
    ...
    Examples:
        >>> _parse_uri_prefix('path/of/your/file')
        ''
