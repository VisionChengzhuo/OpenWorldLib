...
"""
PYTHONPATH=. streamlit run gamma_world/_src/predict2/inference/text2image.py --server.port 2222
"""
...
from gamma_world._src.predict2.datasets.utils import IMAGE_RES_SIZE_INFO
from gamma_world._src.predict2.inference.get_t5_emb import get_text_embedding
from gamma_world._src.predict2.utils.model_loader import load_model_from_checkpoint
...
class Text2ImageInference:
    def __init__(self, experiment_name: str, ckpt_path: str, s3_credential_path: str):
        ...
        model, config = load_model_from_checkpoint(
            ...
            config_file="gamma_world/_src/predict2/configs/text2world/config.py",
