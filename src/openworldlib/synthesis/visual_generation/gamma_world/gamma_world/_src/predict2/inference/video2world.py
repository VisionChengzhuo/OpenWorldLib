...
from projects.cosmos3.interactive.utils.model_loader import (
...
class Video2WorldInference:
    ...
    def __init__(
        ...
        config_file: str = "gamma_world/_src/predict2/configs/video2world/config.py",
        ...
        if TYPE_CHECKING:
            from gamma_world._src.predict2.models.video2world_model_rectified_flow import Video2WorldModelRectifiedFlow
